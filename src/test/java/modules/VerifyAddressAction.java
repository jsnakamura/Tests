...
public class VerifyAddressAction {
	...
	public static void Execute(WebDriver driver, List<HashMap<String, String>> datamap) throws Exception {
		...
		assertEquals(DataHelper.getMapValue(datamap, 0, "Address1") + " " + DataHelper.getMapValue(datamap, 0, "Address2"),
		...
		assertEquals(DataHelper.getMapValue(datamap, 0, "City") 
				+ ", "
				+ DataHelper.getMapValue(datamap, 0, "State") 
				+ " "
